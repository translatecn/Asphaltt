...
#    define PT_REGS_PARM1_CORE_SYSCALL(x) BPF_CORE_READ((const struct pt_regs___s390 *)(x), __PT_PARM1_SYSCALL_REG)
...
#    define __PT_PARM6_SYSCALL_REG __PT_PARM6_REG
#    define PT_REGS_PARM1_SYSCALL(x) PT_REGS_PARM1_CORE_SYSCALL(x)
#    define PT_REGS_PARM1_CORE_SYSCALL(x) BPF_CORE_READ((const struct pt_regs___arm64 *)(x), __PT_PARM1_SYSCALL_REG)
...
#        define BPF_KPROBE_READ_RET_IP(ip, ctx) ({ bpf_probe_read_kernel(&(ip), sizeof(ip), (void *)PT_REGS_RET(ctx)); })
#        define BPF_KRETPROBE_READ_RET_IP(ip, ctx) ({ bpf_probe_read_kernel(&(ip), sizeof(ip), (void *)(PT_REGS_FP(ctx) + sizeof(ip))); })
...
#define BPF_PROG(name, args...)                                                                                                         \
    ...
    static __always_inline typeof(name(0)) ____##name(unsigned long long *ctx, ##args);                                                 \
    typeof(name(0)) name(unsigned long long *ctx) {                                                                                     \
        _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wint-conversion\"") return ____##name(___bpf_ctx_cast(args)); \
        _Pragma("GCC diagnostic pop")                                                                                                   \
    }                                                                                                                                   \
    static __always_inline typeof(name(0)) ____##name(unsigned long long *ctx, ##args)

#ifndef ___bpf_nth2
#    define ___bpf_nth2(_, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22, _23, _24, N, ...) N
#endif
#ifndef ___bpf_narg2
#    define ___bpf_narg2(...) ___bpf_nth2(_, ##__VA_ARGS__, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1, 0)
#endif

#define ___bpf_treg_cnt(t) __builtin_choose_expr(sizeof(t) == 1, 1, __builtin_choose_expr(sizeof(t) == 2, 1, __builtin_choose_expr(sizeof(t) == 4, 1, __builtin_choose_expr(sizeof(t) == 8, 1, __builtin_choose_expr(sizeof(t) == 16, 2, (void)0)))))
...
#define BPF_PROG2(name, args...)                                                                      \
    name(unsigned long long *ctx);                                                                    \
    static __always_inline typeof(name(0)) ____##name(unsigned long long *ctx ___bpf_ctx_decl(args)); \
    typeof(name(0)) name(unsigned long long *ctx) {                                                   \
...
#define BPF_KPROBE(name, args...)                                                                                                          \
    ...
    typeof(name(0)) name(struct pt_regs *ctx) {                                                                                            \
        _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wint-conversion\"") return ____##name(___bpf_kprobe_args(args)); \
        _Pragma("GCC diagnostic pop")                                                                                                      \
    }                                                                                                                                      \
    static __always_inline typeof(name(0)) ____##name(struct pt_regs *ctx, ##args)
...
#define BPF_KRETPROBE(name, args...)                                                                                                          \
    ...
    static __always_inline typeof(name(0)) ____##name(struct pt_regs *ctx, ##args);                                                           \
    typeof(name(0)) name(struct pt_regs *ctx) {                                                                                               \
        _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wint-conversion\"") return ____##name(___bpf_kretprobe_args(args)); \
        _Pragma("GCC diagnostic pop")                                                                                                         \
    }                                                                                                                                         \
    static __always_inline typeof(name(0)) ____##name(struct pt_regs *ctx, ##args)
...
#define BPF_KSYSCALL(name, args...)                                                                                                                                        \
    ...
    static __always_inline typeof(name(0)) ____##name(struct pt_regs *ctx, ##args);                                                                                        \
    typeof(name(0)) name(struct pt_regs *ctx) {                                                                                                                            \
        struct pt_regs *regs = LINUX_HAS_SYSCALL_WRAPPER ? (struct pt_regs *)PT_REGS_PARM1(ctx) : ctx;                                                                     \
        _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wint-conversion\"") if (LINUX_HAS_SYSCALL_WRAPPER) return ____##name(___bpf_syswrap_args(args)); \
