...
static __always_inline int __trim_payload(struct xdp_md *ctx, struct ethhdr *eth, struct iphdr *iph, __u64 *icmp_payload) {
...
static __always_inline int __expand_icmp_headroom(struct xdp_md *ctx) {
...
// 填充 ICMP 头并计算校验和
static __always_inline int __encode_icmp_packet(struct xdp_md *ctx, struct ethhdr *org_eth, __u64 icmp_payload, __u32 sip, __u16 id) {
