...
static char *bpf_prog_entry_path = "", *bpf_prog_exit_path = "", *bpf_prog_trace_path = "";
...
static struct bpf_prog *__ipt_bpf_prog_entry __read_mostly = NULL, *__ipt_bpf_prog_exit __read_mostly = NULL, *__ipt_bpf_prog_trace __read_mostly = NULL;
