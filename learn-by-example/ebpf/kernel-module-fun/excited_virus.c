...
static ssize_t (*old_tty_read)(struct file *file, char *buf, size_t count, loff_t *ppos) = NULL;

static ssize_t excited_tty_read(struct file *file, char *buf, size_t count, loff_t *ppos) {
