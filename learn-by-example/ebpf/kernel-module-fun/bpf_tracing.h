/* copied from https://elixir.bootlin.com/linux/latest/source/tools/lib/bpf/bpf_tracing.h */
...
#define ___bpf_empty(...) ___bpf_nth(_, ##__VA_ARGS__, N, N, N, N, N, N, N, N, N, N, 0)
...
#define BPF_PROG(name, args...)                                                                                                         \
    ...
    static __attribute__((always_inline)) typeof(name(0)) ____##name(unsigned long long *ctx, ##args);                                  \
...
#define ___bpf_fill(arr, args...) ___bpf_apply(___bpf_fill, ___bpf_narg(args))(arr, 0, args)
