...
import (
	...
	"github.com/Asphaltt/go-nfnetlink-example/ebpf/syscalldist/pkg/histogram"
	"github.com/Asphaltt/go-nfnetlink-example/ebpf/syscalldist/pkg/lodash"
...
// go:generate bpf2go -cc clang syscall ./ebpf/syscall.c -- -I./ebpf/headers -Wall -D__TARGET_ARCH_x86
